...
class GCPTemplateAttributeHint(AbstractAttributeHint):
    ...
    def _generate_full_vm_path(
        ...
        service = GCPDataRetrieveService()
...
class GCPVMAttributeHint(GCPTemplateAttributeHint):
    ATTR_NAME = "vCenter VM"
    SEARCH_VM_TEMPLATES = SearchVmTemplates.EXCLUDE


class GCPVMForLinkedCloneAttributeHint(GCPVMAttributeHint):
    SEARCH_VM_TEMPLATES = SearchVmTemplates.INCLUDE
    SEARCH_VM_SNAPSHOTS = SearchVmSnapshots.ONLY


class GCPVMSnapshotAttributeHint(GCPTemplateAttributeHint):
    ATTR_NAME = "vCenter VM Snapshot"
    DEPENDS_ON = GCPVMAttributeHint.ATTR_NAME
