...
class RouteTablesHandler(BaseGCPHandler):
    ...
    def create(
        ...
        operation = self.route_table_client.insert(
            project=self.credentials.project_id, route_resource=route_table
        )
    ...
    def get_route_table_by_name(self, route_table_name: str) -> compute.Route:
        ...
        return self.route_table_client.get(
            project=self.credentials.project_id, route=route_table_name
        )
